...
def user_statistic():
    ...
    return (f"𝐀𝐝𝐦𝐢𝐧 𝐮𝐜𝐡𝐮𝐧 𝐮𝐬𝐞𝐫𝐥𝐚𝐫 𝐒𝐭𝐚𝐭𝐢𝐬𝐭𝐢𝐤𝐚𝐬𝐢 🤖📂\n\n"
            ...
            f"ʀᴏ'ʏʜᴀᴛɢᴀ ᴏʟɪɴɢᴀɴ ʙᴀʀᴄʜᴀ ᴜsᴇʀʟᴀʀ sᴏɴɪ: {len(user.get_medias())}\n\n"
...
def media_statistic():
    ...
    return (f"𝐀𝐝𝐦𝐢𝐧 𝐮𝐜𝐡𝐮𝐧 𝐦𝐞𝐝𝐢𝐚𝐥𝐚𝐫 𝐒𝐭𝐚𝐭𝐢𝐬𝐭𝐢𝐤𝐚𝐬𝐢 🤖📂\n\n"
            ...
            f"𝐁𝐚𝐫𝐜𝐡𝐚 𝐦𝐞𝐝𝐢𝐚𝐥𝐚𝐫 𝐬𝐨𝐧𝐢: {len(pin.get_medias()) + len(likee.get_medias()) + len(tiktok.get_medias()) + len(insta.get_medias())}")
